        ...
        return (
            <div className="order">
                <div className="order">
                    ...
                    <h3 id="textOrder">{this.props.location.state.detail.name}, we have created your order #{this.props.location.state.detail._id}. Your items will be soon at your door.</h3>
