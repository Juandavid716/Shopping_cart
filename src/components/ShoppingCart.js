                      ...
                      <div className="cardOptions">
                        ...
                        <div className="addRemove">
                          <FormGroup row>
                            ...
                            <Col sm={10}>
                              <Input
                                onChange={this.props.updateCart(cartItem)}
                                type="select"
                                name="select"
                                id="exampleSelect"
                                value={cartItem.count}
                              >
                                {this.range(1, 100, 1).map((value) => (
                          ...
                          >
                            <img
                              ...
                              src="https://img.icons8.com/plasticine/64/000000/filled-trash.png"
                            />
                          </div>
                        </div>
                        <div className="price">
                          {parsingPrice(cartItem.price * cartItem.count)}
                        </div>
                      </div>
                    </div>
                  </CardBody>
